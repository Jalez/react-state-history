...
describe('PersistentToggleCounter component', () => {
  ...
  it('supports toggling persistence on and off', async () => {
    ...
    const persistenceCheckbox = await screen.findByLabelText(/Enable State Persistence/);
    ...
    expect(localStorage.getItem('undoredo_history_persistent-toggle-counter')).toBeTruthy();
    ...
    expect(localStorage.getItem('undoredo_history_persistent-toggle-counter')).toBeNull();
  });
